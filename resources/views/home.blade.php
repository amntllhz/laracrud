                                ...
                                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                    ...
                                    <form action="{{ route('mahasiswa.update', $item->nim) }}" method="POST">
                                        ...
                                        <div class="flex items-center space-x-4">                                            
                                            <button name="updatData" id="updateData" data-modal-toggle="view-{{ $item->nim }}" type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">                                            
                                                Update
                                            </button>
                                        </div>
                                    </form>
