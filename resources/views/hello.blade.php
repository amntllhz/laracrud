    ...
    <div class="overflow-hidden flex rounded-3xl shadow-md bg-white p-6 mt-16 ring-1 ring-inset ring-prim/50 items-center">
        ...
        <div class="w-fit ml-6">
            ...
            <form action="/set-session" method="POST">
                @csrf
                <button type="submit" name="set-session" id="set-session" class="inline-flex justify-center items-center py-2 px-5 text-base font-medium text-center text-white rounded-xl bg-prim hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                    Start
