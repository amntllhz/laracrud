    ...
    <div class="flex rounded-2xl shadow-md bg-white p-6 mt-16 ring-1 ring-inset ring-blue-200 items-center">
        ...
        <div class="w-1/2 ml-6">
            ...
            <div class="flex flex-col mb-6">
                <p class="text-5xl font-extrabold text-slate-800 leading-tight mb-2">A Laravel Project <br> With <span class="text-blue-700">C</span>-<span class="text-blue-700">R</span>-<span class="text-blue-700">U</span>-<span class="text-red-600">D</span> Features</p>
                <p class="max-w-md text-base text-gray-600">"Laravel project with user-friendly Create, Read, Update, and Delete features, plus a handy search function!"</p>
            </div>

            {{-- link --}}
            <a href="{{ route('home') }}" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-xl bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                Start
